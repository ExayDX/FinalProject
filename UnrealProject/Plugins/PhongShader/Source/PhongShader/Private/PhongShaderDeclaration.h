...
//BEGIN_UNIFORM_BUFFER_STRUCT(FPhongShaderConstantParameters, )
//DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FVector4, StartColor)
//END_UNIFORM_BUFFER_STRUCT(FPhongShaderConstantParameters)
//
////This buffer is for variables that change very often (each frame for example)
//BEGIN_UNIFORM_BUFFER_STRUCT(FPhongShaderVariableParameters, )
...
//END_UNIFORM_BUFFER_STRUCT(FPhongShaderVariableParameters)
//
//typedef TUniformBufferRef<FPhongShaderConstantParameters> FPhongShaderConstantParametersRef;
//typedef TUniformBufferRef<FPhongShaderVariableParameters> FPhongShaderVariableParametersRef;
//
///************************************************************************/
...
///***************************************************************************/
//class FPhongShaderDeclaration : public FGlobalShader
//{
//	DECLARE_SHADER_TYPE(FPhongShaderDeclaration, Global);
//
//public:
//
//	FPhongShaderDeclaration() {}
//
//	explicit FPhongShaderDeclaration(const ShaderMetaType::CompiledShaderInitializerType& Initializer);
//
...
//	void SetUniformBuffers(FRHICommandList& RHICmdList, FPhongShaderConstantParameters& ConstantParameters, FPhongShaderVariableParameters& VariableParameters);
